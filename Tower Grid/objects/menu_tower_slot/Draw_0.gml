...
{
if store.best_stage>=5 {draw_sprite_ext(spr_turret_machinegun,0,x,y+8,1,1,0,c_white,1)}
...
{
if store.best_stage>=10 {draw_sprite_ext(spr_turret_missilelauncher,0,x,y+8,1,1,0,c_white,1)}
...
if myID=4 //Quad Gun
{
if store.best_stage>=15 {draw_sprite_ext(spr_turret_quadgun,0,x,y+8,1,1,0,c_white,1)}
...
{
if store.best_stage>=20 {draw_sprite_ext(spr_turret_freezeray,0,x,y+8,1,1,0,c_white,1)}
...
{
if store.best_stage>=25 {draw_sprite_ext(spr_turret_toxiccannon,0,x,y+8,1,1,0,c_white,1)}
...
if myID=7 //Hammer
{
if store.best_stage>=30 {draw_sprite_ext(spr_turret_hammer,0,x,y+8,1,1,0,c_white,1)}
...
if myID=8 //Absorber
{
if store.best_stage>=35 {draw_sprite_ext(spr_turret_absorber,0,x,y+8,1,1,0,c_white,1)}
...
if myID=9 //Longshot
{
if store.best_stage>=40 {draw_sprite_ext(spr_turret_longshot,0,x,y+8,1,1,0,c_white,1)}
...
{
if store.best_stage>=45 {draw_sprite_ext(spr_turret_harvester,0,x,y+8,1,1,0,c_white,1)}
