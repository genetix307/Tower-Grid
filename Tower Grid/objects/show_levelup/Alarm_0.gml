...
total_choices=13.99 //UPDATE THIS WHEN ADDING NEW CHOICE
...
instance_create_depth(cx+240,cy+380,depth-10,btn_lvl_upgrade).my_id=slot_1
instance_create_depth(cx+240,cy+450,depth-10,btn_lvl_upgrade).my_id=slot_2
instance_create_depth(cx+240,cy+520,depth-10,btn_lvl_upgrade).my_id=slot_3
