...
draw_text_color(180-txtShift,80,"Wave "+string(store.current_stage),c_black,c_black,c_black,c_black,show_wave-.2)
...
draw_text_color(211,117,"Best "+string(store.best_stage),c_black,c_black,c_black,c_black,show_wave-.2)
