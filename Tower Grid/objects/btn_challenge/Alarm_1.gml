...
if my_id = 6 {myCap=10+(10*store.lvl_headshotking) myName="Headshot King" myDesc="Get "+string(myCap)+" Critical Hits" myReward=20+(30*store.lvl_headshotking) myCur=store.goal_headshotking myLevel=store.lvl_mandown}
