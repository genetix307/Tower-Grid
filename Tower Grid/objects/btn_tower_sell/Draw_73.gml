...
draw_text_color(x-37,y+3,"+"+string(sell_value),c_black,c_black,c_black,c_black,1)
draw_text_color(x-39,y+1,"+"+string(sell_value),c_white,c_white,c_silver,c_silver,1)
