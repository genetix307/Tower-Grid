...
instance_create_depth(x+22,y,1,wpn_quadgun).direction=point_direction(x,y,instance_nearest(x,y,default_enemy).x,instance_nearest(x,y,default_enemy).y)-2
instance_create_depth(x+11,y,1,wpn_quadgun).direction=point_direction(x,y,instance_nearest(x,y,default_enemy).x,instance_nearest(x,y,default_enemy).y)-1
