...
store.missilelauncher_knockback=25
store.missilelauncher_ability="None"
store.missilelauncher_lvl=1
store.quadgun_attack_damage=2
store.quadgun_attack_range=255
store.quadgun_reload_time=90
store.quadgun_critical_chance=1
store.quadgun_knockback=6
...
store.freezeray_knockback=2
store.freezeray_ability="Freeze"
store.freezeray_lvl=1
...
store.absorber_attack_range=240
store.absorber_reload_time=70
store.absorber_critical_chance=1
...
store.synccannon_attack_damage=2
