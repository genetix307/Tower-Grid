...
store.card_slot_3 = 0
store.card_slot_4 = 0
store.card_taxation = 0
store.card_lvl_taxation = 1
store.card_armoredcores = 0
store.card_lvl_armoredcores = 1
store.card_repairdrone = 0
store.card_lvl_repairdrone = 1
store.card_mineshaft = 0
store.card_lvl_mineshaft = 1
store.card_criticalgold = 0
store.card_lvl_criticalgold = 1
store.card_mastery = 0
store.card_lvl_mastery = 1
store.card_extrarations = 0
store.card_lvl_extrarations = 1
store.card_buildinggrant = 0
store.card_lvl_buildinggrant = 1
store.card_airstrike=0
store.card_lvl_airstrike=1
