...
if store.current_stage>69 {maxhp+=floor(store.current_stage/30) attack_damage+=floor(store.current_stage/50)}
...
if store.current_stage>1499 {maxhp+=floor(store.current_stage/10) attack_damage+=floor(store.current_stage/25)}
if store.current_stage>1999 {maxhp+=floor(store.current_stage/10) attack_damage+=floor(store.current_stage/25)}
if store.current_stage>2499 {maxhp+=floor(store.current_stage/10) attack_damage+=floor(store.current_stage/25)}
maxhp*=(store.perk_lvl_evilcreed+1) //Multiply Health by Evil Creed Perk
hp=maxhp
