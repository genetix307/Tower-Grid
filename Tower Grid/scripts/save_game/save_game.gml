...
ini_write_real( "save1", "cannon_ability", store.cannon_ability);
...
ini_write_real( "save1", "machinegun_ability", store.machinegun_ability);
...
ini_write_real( "save1", "missilelauncher_ability", store.missilelauncher_ability);
...
ini_write_real( "save1", "quadgun_ability", store.quadgun_ability);
...
ini_write_real( "save1", "freezeray_ability", store.freezeray_ability);
...
ini_write_real( "save1", "toxiccannon_ability", store.toxiccannon_ability);
...
ini_write_real( "save1", "hammer_ability", store.hammer_ability);
...
ini_write_real( "save1", "absorber_ability", store.absorber_ability);
