...
ini_write_real( "save1", "card_taxation", store.card_taxation);
ini_write_real( "save1", "card_lvl_taxation", store.card_lvl_taxation);
ini_write_real( "save1", "card_armoredcores", store.card_armoredcores);
ini_write_real( "save1", "card_lvl_armoredcores", store.card_lvl_armoredcores);
ini_write_real( "save1", "card_repairdrone", store.card_repairdrone);
ini_write_real( "save1", "card_lvl_repairdrone", store.card_lvl_repairdrone);
ini_write_real( "save1", "card_mineshaft", store.card_mineshaft);
ini_write_real( "save1", "card_lvl_mineshaft", store.card_lvl_mineshaft);
ini_write_real( "save1", "card_criticalgold", store.card_criticalgold);
ini_write_real( "save1", "card_lvl_criticalgold", store.card_lvl_criticalgold);
ini_write_real( "save1", "card_mastery", store.card_mastery);
ini_write_real( "save1", "card_lvl_mastery", store.card_lvl_mastery);
ini_write_real( "save1", "card_extrarations", store.card_extrarations);
ini_write_real( "save1", "card_lvl_extrarations", store.card_lvl_extrarations);
ini_write_real( "save1", "card_buildinggrant", store.card_buildinggrant);
ini_write_real( "save1", "card_lvl_buildinggrant", store.card_lvl_buildinggrant);
ini_write_real( "save1", "card_airstrike", store.card_airstrike);
ini_write_real( "save1", "card_lvl_airstrike", store.card_lvl_airstrike);
