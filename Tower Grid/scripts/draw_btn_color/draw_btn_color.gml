...
if store.color_scheme=2 {draw_rectangle_color(x-sprite_width/2,y-sprite_height/2,x+sprite_width/2,y+sprite_height/2,c_green,c_green,c_olive,c_olive,false)}
if store.color_scheme=3 {draw_rectangle_color(x-sprite_width/2,y-sprite_height/2,x+sprite_width/2,y+sprite_height/2,c_red,c_red,c_maroon,c_maroon,false)}
if store.color_scheme=4 {draw_rectangle_color(x-sprite_width/2,y-sprite_height/2,x+sprite_width/2,y+sprite_height/2,c_fuchsia,c_fuchsia,c_purple,c_purple,false)}
