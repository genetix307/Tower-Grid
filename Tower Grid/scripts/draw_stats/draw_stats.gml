...
draw_set_alpha(.75)
draw_set_color(c_black)
draw_rectangle(cx+176,cy+27,cx+330,cy+47,false)
draw_set_alpha(.5)
draw_set_color(c_gray)
draw_rectangle(cx+177,cy+28,cx+329,cy+46,false)
draw_rectangle_colour(cx+178,cy+28,cx+((store.xp/store.next_level)*150)+179,cy+46,c_purple,c_purple,c_maroon,c_purple,false)
draw_set_alpha(.95)
draw_set_color(c_black)
draw_text(cx+183,cy+31,"Level "+string(store.level)+"  "+string(ceil(store.xp))+"/"+string(ceil(store.next_level)))               
draw_set_color(c_white)
draw_text(cx+181,cy+30,"Level "+string(store.level)+"  "+string(ceil(store.xp))+"/"+string(ceil(store.next_level)))       
}