...
draw_text_color(118,320,"Towers Built: "+string(store.towers_built),c_white,c_white,c_silver,c_silver,1)
draw_text_color(118,350,"Towers Upgraded: "+string(store.towers_upgraded),c_white,c_white,c_silver,c_silver,1)
